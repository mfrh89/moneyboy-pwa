                ...
                <div className="flex items-center gap-2 shrink-0">
                  {onToggleExcluded && (
                    <button
                      ...
                      className={`w-11 h-11 flex items-center justify-center transition-opacity ${item.excluded ? 'opacity-60' : 'opacity-100 can-hover:opacity-0 can-hover:group-hover:opacity-30'}`}
