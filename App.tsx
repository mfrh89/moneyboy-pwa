      ...
      <main className="max-w-7xl mx-auto p-4 md:p-10 space-y-12">
        ...
        {view === ViewState.SETTINGS && (
             <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <div className="mb-4">
                  <h2 className="text-[1.5rem] md:text-[2.5rem] font-bold text-on-surface tracking-[-0.02em] leading-[1.15]">Einstellungen</h2>
                </div>
        ...
        {view === ViewState.ANALYSIS && (
            <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-300">
                <h2 className="text-[1.5rem] md:text-[2.5rem] font-bold text-on-surface tracking-[-0.02em] leading-[1.15]">Analyse</h2>
